...
public class MemberController {
    ...
    public String memberModi(@RequestParam("m_idx") int m_idx, Model model){

        MemberDTO memberDTO = memberService.getMemberInfo(m_idx);
        model.addAttribute("m_modi",memberDTO);
